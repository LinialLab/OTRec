...
(\textit{vii})~\textbf{TF-IDF cosine}: lexical similarity between
concatenated disease and target text fields;
(\textit{viii})~\textbf{Frozen biomedical encoder}: normalized
...
($0.811$ / $0.265$) and TF-IDF ($0.513$ / $0.106$) remain much weaker
