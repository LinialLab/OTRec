...
Training used TensorFlow/Keras~\citep{chollet2015}, Adam (LR $8{\times}10^{-3}$, batch size $1{,}024$), BinaryCrossentropy loss, ReduceLROnPlateau (factor 0.2, patience 1) and early stopping (patience 2) on a held-out 5\% validation set.
...
This is actionable than many orphan predictions because DHODH inhibition is already clinically accessible through leflunomide and teriflunomide. 
