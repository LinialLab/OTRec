...
elementwise product, and cosine similarity. Due to compute cost, this
baseline was run with the same target-disjoint protocol but over
$4{\times}5$ folds rather than $5{\times}5$.
...
$0.912 \pm 0.009$ ROC-AUC and $0.664 \pm 0.031$ PR-AUC - above the simple priors, but below the best models in PR-AUC.
...
Frozen BioClinical-ModernBERT + MLP & 0.912 & 0.009 & 0.664 & 0.031 \\
\midrule
